...
public enum CaseBAuthentication {
    ...
    /// fuera de git), distinta de la clave determinística de prueba que
    /// usan los vectores de `spec/test-vectors.json`
    ...
    public static let backendPublicKeyX25519: Data = hexToData(
        "4a5915cf192399053c2866bb76a781e92d4ca2e0c787067e2ce42fe44550ed67"
    )
